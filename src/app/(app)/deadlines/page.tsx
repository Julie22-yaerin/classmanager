    ...
    <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-500">Extracted automatically from Teacher Announcements and Class Recordings across every class.</p>
        </div>
      ...
      {view === "calendar" ? (
        <LocalCalendar deadlines={deadlines} />
      ) : (
        <>
